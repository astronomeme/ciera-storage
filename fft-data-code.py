# -*- coding: utf-8 -*-
"""
Created on Mon Jul 26 10:02:39 2021
...
filename1 = open('data-output','r')
dummy1 = pd.read_csv('data-output', delim_whitespace=False, comment='#', header=None)
#print(dummy1)
...
with open('fft-data-output', 'w',encoding="ISO-8859-1",newline='') as csv_file:
